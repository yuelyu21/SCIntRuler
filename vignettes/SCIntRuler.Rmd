...
To install the package, install its Bioconductor dependencies first.
...
`SCIntRuler` can be installed from CRAN. The development source is available at [GitHub](https://github.com/yuelyu21/SCIntRuler).
...
leg <- cowplot::get_legend(p5 + theme(legend.position = "right"))
