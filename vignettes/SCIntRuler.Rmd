...
#### Run Harmony
Harmony is an algorithm for performing integration of single cell genomics datasets. To run harmony, we need to install `harmony` package first. For more information, please see [Quick start to Harmony](https://portals.broadinstitute.org/harmony/articles/quickstart.html).
...
```{r integration, fig.height=8, fig.width=8}
...
# 
# sticker(plot, package="SCIntRuler", p_size=18, p_x = 1,p_y = 1,
